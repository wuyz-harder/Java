...
// updateFunctionComponent会调用renderWithHooks
        ...
        for (let i = 0; i < mutableSourceEagerHydrationData.length; i += 2) {
          const mutableSource = ((mutableSourceEagerHydrationData[
            ...
            if (isDirectTextChild) {
              // 如果标签里面只是文字或者数字或者textarea这些标签，就默认没有孩子了
  ...
  if (__DEV__) {
    ...
    function bailoutOnAlreadyFinishedWork(
      ...
      if (!includesSomeLane(renderLanes, workInProgress.childLanes)) {
        ...
        // fibers and continue.
        // childlanes代表儿子是否要更新，lanes则代表自己的
    ...
    function beginWork(
      ...
      // current !== null表示是更新阶段，current不为空
      if (current !== null) {
        ...
        if (
          ...
          // 如果type不相等也就是标签类型不相等就直接表示需要update
