...
// 开发环境的不用管
  ...
  if (__DEV__) {
    ...
    // 如果current或者memoizedState就说明是首次挂载
  ...
  if (didScheduleRenderPhaseUpdateDuringThisPass) {
    ...
    do {
      ...
      currentHook = null;
      // 以理解 workInProgress树上指向的当前调度的 hooks节点。
      workInProgressHook = null;
...
// 更新的时候每次拿出的hook都是最新的，就是按照顺序排列的
// 假如有一个被跳过了，那拿的事实上是前一个的
// 主要是在于重新执行APP()的时候
// 会一个一个的接下来执行
...
function updateReducer<S, I, A>(
  ...
  if (pendingQueue !== null) {
    // 说明我们还有更新没有执行，所以要把他们加入到base queue
